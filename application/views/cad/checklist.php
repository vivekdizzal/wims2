<div class="dialog_con1 checklist_form">
    <form class="bs-example form-horizontal" id="cad_checklist_form">
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group"> 
                    ...
                    <div class="col-lg-7"> 
                        ...
                        <input type="text" class="form-control cad_check_ajax" name="cl_aperture_content" id="cl_aperture_content" data-id="cl_aperture_content">
                    </div>
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-lg-7"> 
                        <input type="text" class="form-control cad_check_ajax" name="bot_ref_des" id="bot_ref_des" data-id="bot_ref_des">  
                    </div>
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-lg-7" style="padding: 0;">  
                        <div class="col-lg-6">  
                            <label> 
                                <input type="text" class="form-control cad_check_ajax" name="cl_foil_thik[]" data-id="cl_foil_thik">
                            </label>
                        </div>
                        <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-lg-7" style="padding: 0;">  
                        <div class="col-lg-6">  
                            <label> <input type="text" class="form-control cad_check_ajax" name="cl_fiducial_qty[]" id="cl_fiducial_qty" data-id="cl_fiducial_qty"></label> 
                        </div>
                        <div class="col-lg-6">
                            <a href="#" class="add_more_in_chklist">Add more</a>
                        </div>
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-lg-7" style="padding: 0;">  
                        <div class="col-lg-6">  
                            <label> <input type="text" class="form-control cad_check_ajax" name="cl_fiducial_dcode[]" id="cl_fiducial_dcode" data-id="cl_fiducial_dcode"> </label> 
                        </div>
                        <div class="col-lg-6">
                            <a href="#" class="add_more_in_chklist">Add more</a>
                        </div>
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-lg-7"> 
                        <select class="form-control cad_check_ajax" name="cl_border_used" id="cl_border_used" data-id="cl_border_used">
        ...
        <div class="row cad_form">
            <div class="col-lg-6">
                <div class="form-group"> 
                    <input type="checkbox" name="lead_free_mark" id="lead_free_mark" class="cad_ajax_chkboxes" data-id="lead_free_mark"> 
                    <label class="col-lg-5 control-label lead_free_mark" for="lead_free_mark">
                        Lead Free
                    </label> 
                    <input type="checkbox" name="ship_tooling" id="ship_tooling" class="cad_ajax_chkboxes" data-id="ship_tooling">
                    <label class="col-lg-5 control-label"  for="ship_tooling">
                        Ship W/ Tooling
                    </label> </div> <div class="form-group"> 
                    <input type="checkbox" name="fg_material" id="fg_material" class="cad_ajax_chkboxes" data-id="fg_material">
                    <label for="fg_material" class="col-lg-5 control-label">
                        Datum FG
                    </label>
                    <input type="checkbox" name="inspect_template" id="inspect_template" class="cad_ajax_chkboxes" data-id="inspect_template">
                    <label for="inspect_template" class="col-lg-5 control-label">
                        Ship W/ Template
                    </label> 
                </div>
            </div>
            <div id="lead_free_mark_em" style="color:red;"></div>
            <div id="ship_tooling_em" style="color:red;"></div>
            <div id="fg_material_em" style="color:red;"></div>
            <div id="inspect_template_em" style="color:red;"></div>
            <div class="col-lg-6">
                <div class="form-group"> 
                    <input type="checkbox" name="epo_coat" id="electropolish" class="cad_ajax_chkboxes" data-id="epo_coat">
                    <label for="electropolish" class="col-lg-5 control-label">
                        Electropolish
                    </label> 

                    <input type="checkbox" name="film_plots" id="film_plots" class="cad_ajax_chkboxes" data-id="film_plots">
                    <label for="film_plots" class="col-lg-5 control-label">
                        Ship W/ Plot
                    </label> 
                </div>
                <div id="epo_coat_em" style="color:red;"></div>
                <div id="film_plots_em" style="color:red;"></div>

                <div class="form-group"> 
                    <input type="checkbox" name="nano_coat" id="nano_coat" class="cad_ajax_chkboxes" data-id="epo_coat">
                    <label for="nano_coat" class="col-lg-5 control-label">
                        Nano Coat
                    </label> 

                    <input type="checkbox" name="premium" id="premium" class="cad_ajax_chkboxes" data-id="premium">
                    <label for="premium" class="col-lg-5 control-label">
                        Premium
                    </label> 

                </div> <div id="epo_coat_em" style="color:red;"></div>
                <div id="inspect_template_em" style="color:red;"></div>
                <div class="form-group"> 
                    <input type="checkbox" name="s_sample"  id="s_sample" class="cad_ajax_chkboxes" data-id="s_sample">
                    <label for="s_sample" class="col-lg-5 control-label">
                        S&R using sample
                    </label> 
                    <input type="checkbox" name="scaling" id="scaling" class="cad_ajax_chkboxes" data-id="scaling">
                    <label for="scaling" class="col-lg-5 control-label">
                        Scaling
                    </label> 
        ...
        <div class="row">
            <div class="col-lg-12"> 
                ...
                </div><div id="check_drawing_em"></div>
                <div class="form-group">
                ...
                </div><div id="silkscr_check_em"></div>
                <div class="form-group">
