...
<!--                    <input type="checkbox" name="sc_nano_coat" id="nano_coat" class="cad_ajax_chkboxes" value="Nano Coat" data-id="epo_coat">
                    ...
                    <input type="checkbox" name="sc_premium" id="premium" class="cad_ajax_chkboxes" data-id="premium">
                    <label for="premium" class="col-lg-3 control-label" style="width: 172px;">
                        Premium
                    </label> 
                    <input type="checkbox" name="sc_s_sample"  id="s_sample" class="cad_ajax_chkboxes" data-id="s_sample">
                    <label for="s_sample" class="col-lg-3 control-label">
                        S&R using sample
                    </label> 
                    <input type="checkbox" name="sc_scaling" id="scaling" class="cad_ajax_chkboxes" data-id="scaling">
        ...
        <div class="row">
            <div class="col-lg-12"> 
                <div class="form-group col-lg-12">
                    <input type="checkbox" name="sc_cp_1" id="cust_instr" data-id="cust_instr" class="control-label-check" ><label class="">Review customer instructions. Don't proceed if unclear</label> 
                </div>
				<div id="cust_instr_em" class="errorMessage"></div>
                <div class="form-group col-lg-12">
                    <input type="checkbox" name="sc_cp_2" id="check_drawing" data-id="check_drawing" class="control-label-check" ><label class="">Check all .pdf,.dxf,.dwg,.hpg or other drawing files to see if board is panelised</label> 
                    
                </div><div id="check_drawing_em" class="errorMessage"></div>
                <div class="form-group col-lg-12">
                    <input type="checkbox" name="sc_cp_3" id="silkscr_check" data-id="silkscr_check" class="control-label-check" ><label class="">Verify ther are no missing smt pads by checking against silkscreen and mask.</label> 
                    
                </div><div id="silkscr_check_em" class="errorMessage"></div>
                <div class="form-group col-lg-12">
                    <input type="checkbox" name="sc_cp_4" id="spl_instr" data-id="spl_instr" class="control-label-check" ><label class="">Reverify customer special instructions.</label> 
                ...
                <div class="form-group">
                    <div class="col-sm-12">
						...
						<div class="col-lg-2 control-label pull-right text-right">
                            <button class="pull-right print_stencil btn btn-success" onclick="printDiv('print_checklist')"type="submit" value="Print">Print</button>
                        </div>
                    </div>
                </div>
				<div>
