<div class="dialog_con1 pull-left checklist_form">
    <form class="bs-example form-horizontal to_submit" action="<?php echo base_url("cad/checklist_submit"); ?>" id="cad_template_checklist_form">
		...
		<h4 class="text-center">TEMPLATE ORDER</h4>
			...
			<div class="col-lg-2">
				<input type="radio" name="tc_template_type" id="smt_only">  <label for="smt_only">SMT ONLY</label>
			</div>
			<div class="col-lg-2">
				<input type="radio" name="tc_template_type" id="smt_pth">  <label for="smt_pth">SMT & PTH </label>
			</div>
			<div class="col-lg-5">
				<div class="col-lg-6"><input type="radio" name="tc_template_type" id="other_spc">  <label for="other_spc">OTHER (specify)</label></div>
		...
		<div class="row padding">
			...
			<div class="col-lg-8">
				<div class="row padding">
					...
					<div class="col-lg-3"><input type="text" name="tc_temp_size1" class="form-control"></div>
					<div class="col-lg-1">x</div>
					<div class="col-lg-3"><input type="text" name="tc_temp_size2" class="form-control"></div>
				</div>
			</div>
			<div class="row">
			<div class="col-lg-12">
