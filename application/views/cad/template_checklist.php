<div class="dialog_con1 pull-left checklist_form" id="template_checklist">
    <form class="bs-example form-horizontal to_submit" action="<?php echo base_url("cad/checklist_submit"); ?>" id="cad_template_checklist_form">
        ...
        <input type="hidden" name="tc_completed" value="1">
        ...
        <div class="row padding check_style">
            ...
            <div class="col-lg-8">
                <div class="row padding">
                    ...
                    <div class="col-lg-2" style="padding-left: 4px;"><input type="text" name="tc_temp_size1" id="tc_temp_size1" class="form-control"></div>
                    <div class="col-lg-1">x</div>
                    <div class="col-lg-2" style="padding-left: 4px;"><input type="text" name="tc_temp_size2" id="tc_temp_size2" class="form-control"></div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="col-lg-8 pull-left form-group">
                        ...
                        <div class="col-lg-2">
                            <input type="text" name="tc_temp_qty" class="form-control">
                        </div>
                    </div>
                </div>
                <!--			<div class="col-lg-12">
...
<script>
    $(document).ready(function(){
        $("body").on('blur',"#tc_temp_size2",function(){
//            alert("hi");
//    window.onbeforeunload = function() {
    sessionStorage.setItem(tc_temp_size2, $('#tc_temp_size2').val());
    sessionStorage.setItem(tc_temp_size1, $('#tc_temp_size1').val());
...
//}
    ...
    var tc_temp_size2 = sessionStorage.getItem(tc_temp_size2);
    var tc_temp_size1 = sessionStorage.getItem(tc_temp_size1);
    alert(tc_temp_size2);
    if (tc_temp_size2 !== null) $('#tc_temp_size2').innerHtml(tc_temp_size2);
if (tc_temp_size1 !== null) $('#tc_temp_size1').innerHtml(tc_temp_size1);
    // ...
